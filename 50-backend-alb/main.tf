module "backend_alb" {
    ...
    version = "9.16.0"
    internal = true     # true to make load balancer private. default is false and it will be public
...
resource "aws_route53_record" "backend_alb" {
  ...
  alias {
    ...
    zone_id                = module.backend_alb.zone_id   # This is the hosted(backend_alb) zone ID of the ALB
