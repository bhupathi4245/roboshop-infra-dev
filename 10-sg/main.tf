...
# mongodb accepting connections from vpn, bastion on ports 22, 27017 and for catalogue and user on port 27017
...
# Redis accepting connections from vpn, bastion on ports 22 , 6379 and for user and cart on port 6379
...
# MySQL accepting connections from vpn, bastion on ports 22 , 3306 and shippment on port 3306
...
# RabbitMQ accepting connections from vpn, bastion on ports 22 , 5672 and payments on port 5672
...
# Catalogue - accepting connections from vpn, bastion on ssh ports 22 and vpn and backend_alb on http port 8080
...
# User - accepting connections from vpn, bastion on ssh ports 22 and vpn and backend_alb on http port 8080
...
# Cart - accepting connections from vpn, bastion on ssh ports 22 and vpn and backend_alb on http port 8080
...
# Shipping - accepting connections from vpn, bastion on ssh ports 22 and vpn and backend_alb on http port 8080
...
# Payment - accepting connections from vpn, bastion on ssh ports 22 and vpn and backend_alb on http port 8080
...
# Backend ALB accepting connections from vpn, bastion host, frontend, cart, shipping and payment on port number 80
...
# Frontend - accepting connections from vpn, bastion on ssh port 22 and from frontend_alb from http port 80
...
# Frontend ALB - accepting http and https connections on ports 80 and 443 respectively
